{application,aliter,
             [{description,"Aliter Ragnarok Online server emulator."},
              {vsn,"0"},
              {registered,[]},
              {modules,[aliter,aliter_sup,char_sup,char_fsm,char_packets,
                        char_packets_24,char_srv,config,gen_server_tcp,log,
                        login_sup,login_fsm,login_packets,login_srv,maps,nif,
                        packets,packets_24,packets_25,packets_26,packets_27,
                        zone_sup,zone_commands,zone_fsm,zone_map,zone_master,
