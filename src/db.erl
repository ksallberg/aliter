        ...
        case Char#char.id of
            undefined ->
                ...
                Eq3 = #equip{index = 5,
                             ...
                             bind_on_equip_type = 0,
                             sprite_number = 110},
                save_equips(C, "char:" ++ integer_to_list(X), Eq1),
                save_equips(C, "char:" ++ integer_to_list(X), Eq2),
                save_equips(C, "char:" ++ integer_to_list(X), Eq3),
                X;
            X -> X
        end,
...
save_equips_ext(C, CharID, Equip) ->
    Hash = "char:" ++ integer_to_list(CharID),
    save_equips(C, Hash, Equip).
